...
if path.isfile(dotenv_file): # Convenience for development xp
...
CORS_ALLOWED_ORIGINS = getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:8000').split(',')
...
SITE_NAME = "FlareUp Network"


# Oath2 settings - Google
